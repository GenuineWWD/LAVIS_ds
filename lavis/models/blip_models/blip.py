...
class BlipBase(BaseModel):
    ...
    def init_tokenizer(cls):
        #tokenizer = BertTokenizer.from_pretrained("/public/home/hpctest_xjtu/data/hf_home/bert-base-uncased")
        tokenizer = BertTokenizer.from_pretrained("/public/home/acehekbmzh/data/hf_home/bert-base-uncased/")
